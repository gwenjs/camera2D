...
import type { PathOpts, CameraWaypoint } from '@gwenjs/camera-core'
...
function logAndThrow(log: Camera2DHandleLog, error: Error & { code?: string; hint?: string; docsUrl?: string }): never {
...
export function createCamera2DHandle(id: EntityId, engine: GwenEngine, log: Camera2DHandleLog): Camera2DHandle {
  return {
    ...
    shake(intensity) {
      ...
      engine.addComponent(id, CameraShake, { trauma })
    },
